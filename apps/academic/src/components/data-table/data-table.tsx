	...
	return (
		<div className={cn("flex flex-col gap-4", className)}>
			{showToolbar && (showSearchInput || renderToolbar) && (
				<div
					className={cn(
						"flex flex-col gap-3 rounded-lg bg-slate-100 p-4 md:flex-row md:items-center md:justify-between",
						toolbarClassName,
					)}
				>
					{showSearchInput ? (
			...
			<div className="rounded-lg bg-slate-100 p-2">
				<div className="overflow-x-auto">
					<table className={cn("w-full text-sm text-slate-700", tableClassName)}>
						{caption ? (
